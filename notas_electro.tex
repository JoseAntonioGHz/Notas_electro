...
This problem is exactly the same one that the system shown in \ref{Imagemethod},
 \begin{figure}
 	\centering
 	\includegraphics[width=0.4\textwidth]{figs/Imagemethod.png}
...
\end{equation}
then \eqref{potentialforgraondedplane} obeys the Poison equation, the differential equation for the system and the boundary condition $\psi(x,y,0)=0$.
